<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="tatCaSP.aspx.cs" Inherits="tatCaSP" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <link type="text/css" rel="stylesheet" href="zoomanh.css" />
     <div >
    ...
    <asp:Button ID="Button1" runat="server" Text="1" ForeColor="Red" Width="30px" align="center" BorderColor="Black" OnClick="Button1_Click"/>
                ...
                <asp:Button ID="Button2"  runat="server" Text="2" ForeColor="Red" Width="30px" align="center" BorderColor="Black" OnClick="Button2_Click"/>
